Pod::Spec.new do |s|
  ...
  s.subspec 'core' do |core|
    ...
    core.source_files = 'VIP\ Library/*.{h,m}', 'VIP\ Library/Actions/*.{h,m"}', 'VIP\ Library/Additions/*.{h,m}', 'VIP\ Library/Audio/*.{h,m}', 'VIP\ Library/cocos2d Unofficial Sources/**/*.{h,m}', 'VIP\ Library/Database/**/*.{h,m}', 'VIP\ Library/PDF/*.{h,m}', 'VIP\ Library/Social\ Networks/*.{h,m}', 'VIP\ Library/Sprites/**/*.{h,m}', 'VIP\ Library/Support/*.{h,m}', 'VIP\ Library/Transitions/*.{h,m}', 'VIP\ Library/XML/**/*.{h,m}'
    core.exclude_files = arc_files
    core.public_header_files = 'VIP\ Library/*.h', 'VIP\ Library/Actions/*.h', 'VIP\ Library/Additions/*.h', 'VIP\ Library/Audio/*.h', 'VIP\ Library/cocos2d Unofficial Sources/**/*.h', 'VIP\ Library/Database/**/*.h', 'VIP\ Library/PDF/*.h', 'VIP\ Library/Social\ Networks/*.{h,m}', 'VIP\ Library/Sprites/**/*.h', 'VIP\ Library/Support/*.h', 'VIP\ Library/Transitions/*.h', 'VIP\ Library/XML/**/*/h'
